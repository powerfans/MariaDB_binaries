...
# rpm -Uvh MariaDB-10.4.17-1.el7.centos.src.rpm
# ##
# ## ls -la mariadb-10.4.17.tar.gz
# ## -rw-r--r-- 1 root root 72875692 Jan 11 11:06 mariadb-10.4.17.tar.gz
# ## ls -la /root/rpmbuild/SOURCES/MariaDB-10.4.17.tar.gz 
# ## -rw-r--r-- 1 root root 72663348 Nov 10 18:03 /root/rpmbuild/SOURCES/MariaDB-10.4.17.tar.gz
# ## replace mariadb-10.4.17.tar.gz with tar.gz source
# rm -f /root/rpmbuild/SOURCES/MariaDB-10.4.17.tar.gz
# cp mariadb-10.4.17.tar.gz /root/rpmbuild/SOURCES/MariaDB-10.4.17.tar.gz
